---
title: "previsao_autuacao_mensal_knn"
...
```{r}
ts_valor_pago_total_mes <- ts_data(df_ordenado_valor_pago_total_mes$valor_pago_total, 12)
...
#treinamento modelo
model <- ts_knn(preproc, input_size=2, k=8)
